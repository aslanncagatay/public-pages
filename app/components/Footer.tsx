        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              ...
              İşletmenizi dijitalleştirin, büyütün.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/people/QuickOrder/"
                target="_blank"
              ...
              <a
                href="https://x.com/QuickorderPostr"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a
                href="https://linkedin.com/company/quickorderpossistemi"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                href="https://www.instagram.com/quickorderpossistemleri/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a
                href="https://www.youtube.com/@QuickorderAdisyonSistemi"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="YouTube"
              ...
              <a
                href="https://whatsapp.com/channel/0029VazJewhJJhzajgDKnf1p"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="WhatsApp"
          ...
          {/* Çözümler */}
          <div>
            <h3 className="text-white font-semibold mb-4">Çözümler</h3>
